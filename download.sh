...
curl -f --retry 3 -LO "https://sourceforge.net/projects/boost/files/boost/${MAJOR}.${MINOR}.${PATCH}/boost_${MAJOR}_${MINOR}_${PATCH}.7z" || rm -f "boost_${MAJOR}_${MINOR}_${PATCH}.7z"
